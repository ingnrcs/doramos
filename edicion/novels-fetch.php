...
while($row = mysql_fetch_row($g)){
  $tmpl .= sprintf('<tr><td>%u</td><td>%u</td><td>%s</td><td><a href="/edicion/chapter-add/?id=%u"><i class="icon-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="if(!confirm(\'Esta seguro que desea borrar esto?\')) return false;" href="/edicion/del/?id=%u&amp;obj=cap"><i class="icon-remove"></i></a></td></tr>', (int)$row[0], (int)$row[1], $row[2], (int)$row[0], (int)$row[0]);
}
